export default {
  ...
  setup: {
    title: 'uzApi Setup',
    description: 'Configure your uzApi instance',
    database: {
  ...
  auth: {
    ...
    passwordHint: 'At least 8 characters and must include both letters and numbers',
    emailRequired: 'Email is required',
    invalidEmail: 'Please enter a valid email address',
    passwordRequired: 'Password is required',
    passwordMinLength: 'Password must be at least 6 characters',
    passwordFormat: 'Password must be at least 8 characters and include both letters and numbers',
    ...
    sliderVerificationRequired: 'Please complete the slider verification',
    sliderVerificationHint: 'Slide right to complete the puzzle',
    sliderVerificationPassed: 'Slider verification passed',
    sliderVerificationFailed: 'Slider verification failed. Please try again.',
    ...
    resendCountdownShort: '{countdown}s',
    ...
    codeVerifiedSuccess: 'Email verification code confirmed',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. uzapi-backups), choose a region',
    ...
    accounts: {
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by uzapi, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within uzapi.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another uzapi instance.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for uzApi end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for uzApi end-user login',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How much CNY balance the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: pay 1 CNY, credit {usd} CNY balance',
        billingCurrency: 'Balance Currency',
        pricingCurrency: 'Pricing Currency',
        usdCnyExchangeRate: 'USD/CNY Rate',
        usdCnyExchangeRateHint: 'Fallback rate when automatic exchange rate is unavailable',
        exchangeRateAuto: 'Auto-fetch live rate',
      ...
      smtp: {
        title: 'SMTP Settings',
        description: 'Configure email delivery for verification codes. For Gmail, use smtp.gmail.com with TLS and an App Password.',
        testConnection: 'Test Connection',
        testing: 'Testing...',
        host: 'SMTP Host',
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'uzApi',
        useTls: 'Use TLS',
        useTlsHint: 'Enable TLS encryption for the SMTP connection. Gmail and similar providers usually require it.'
      },
      testEmail: {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to uzApi',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">uzApi is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of uzApi, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to uzApi',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the uzApi AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: pay 1 CNY, credit {usd} CNY balance',
