export default {
  ...
  auth: {
    ...
    passwordHint: '至少 8 位，必须同时包含字母和数字',
    emailRequired: '请输入邮箱',
    invalidEmail: '请输入有效的邮箱地址',
    passwordRequired: '请输入密码',
    passwordMinLength: '密码至少需要 6 个字符',
    passwordFormat: '密码须至少 8 位，且同时包含字母和数字',
    ...
    sliderVerificationRequired: '请完成滑块验证',
    sliderVerificationHint: '向右滑动完成拼图验证',
    sliderVerificationPassed: '滑块验证已通过',
    sliderVerificationFailed: '滑块验证失败，请重试',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 uzapi-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    accounts: {
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 uzapi 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 uzapi 端解除该限制。',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 uzapi 实例的场景。',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 uzApi 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 uzApi 用户登录',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每支付 1 元人民币实际到账多少人民币余额',
        balanceRechargePreview: '预览：支付 1 元，到账 {usd} 元余额',
        billingCurrency: '余额币种',
        pricingCurrency: '模型价格币种',
        usdCnyExchangeRate: 'USD/CNY 汇率',
        usdCnyExchangeRateHint: '自动汇率不可用时使用该兜底汇率',
        exchangeRateAuto: '自动获取实时汇率',
      ...
      smtp: {
        title: 'SMTP 设置',
        description: '配置用于发送验证码的邮件服务。若使用 Gmail，请填写 smtp.gmail.com，并启用 TLS 与 App Password。',
        testConnection: '测试连接',
        testing: '测试中...',
        host: 'SMTP 主机',
        ...
        useTls: '使用 TLS',
        useTlsHint: '为 SMTP 连接启用 TLS 加密。Gmail 等服务通常需要开启。'
      },
      testEmail: {
        title: '发送测试邮件',
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 uzApi 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 uzApi',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 uzApi AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: '当前倍率：支付 1 元，到账 {usd} 元余额',
    refundReason: '退款原因',
