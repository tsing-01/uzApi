...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		SiteName:                         s.getStringOrDefault(settings, SettingKeySiteName, "uzApi"),
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingBillingCurrency:                              defaultBillingCurrency,
		SettingPricingCurrency:                              defaultPricingCurrency,
		SettingUSDToCNYRate:                                 strconv.FormatFloat(defaultUSDToCNYRate, 'f', 6, 64),
		SettingExchangeRateAuto:                             "false",
