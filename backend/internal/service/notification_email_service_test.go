...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "uzApi", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "uzApi", "https://example.com/reset", "en-US"))
