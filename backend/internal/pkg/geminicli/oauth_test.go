...
const (
	testBuiltinClientID     = "test-gemini-cli-client-id"
	testBuiltinClientSecret = "test-built-in-secret"
)

func setTestBuiltinOAuthClient(t *testing.T) {
	t.Helper()
	oldID := GeminiCLIOAuthClientID
	oldSecret := GeminiCLIOAuthClientSecret
	GeminiCLIOAuthClientID = testBuiltinClientID
	GeminiCLIOAuthClientSecret = testBuiltinClientSecret
	t.Setenv(GeminiCLIOAuthClientIDEnv, testBuiltinClientID)
	t.Setenv(GeminiCLIOAuthClientSecretEnv, testBuiltinClientSecret)
	t.Cleanup(func() {
		GeminiCLIOAuthClientID = oldID
		GeminiCLIOAuthClientSecret = oldSecret
	})
}
...
func TestEffectiveOAuthConfig_NoBuiltinCredentials(t *testing.T) {
	oldID := GeminiCLIOAuthClientID
	oldSecret := GeminiCLIOAuthClientSecret
