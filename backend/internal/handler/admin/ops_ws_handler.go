...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["uzapi-admin", "jwt.<token>"].
	// - We always select "uzapi-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"uzapi-admin"},
}
